...
class SurveyScreenWithAAC extends StatefulWidget {
  const SurveyScreenWithAAC({super.key});

  @override
  _Survey createState() => _Survey();
}

class _Survey extends State<SurveyScreenWithAAC> { // 질문 정보를 가져와서 출력해주는 클래스
